...
_extend(KWidget, {
	init : function(options) {
		...
		self.div = K('<div style="width:100%"></div>');
...
_extend(KEdit, KWidget, {
	init : function(options) {
		...
		self.iframe = K('<iframe class="ke-edit-iframe" hidefocus="true" frameborder="0"' + iframeSrc + '></iframe>').css('width', '98%');
...
KEditor.prototype = {
	...
	create : function() {
		...
		container.removeClass('container')
			.addClass('ke-container ke-container-' + self.themeType).css('width', /*width*/"98%");
		if (fullscreenMode) {
			container.css({
				position : 'absolute',
				left : 0,
